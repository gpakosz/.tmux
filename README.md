...
```
$ cd
$ git clone https://github.com/regmicmahesh-dotfiles/.tmux.git
...
```
$ git clone https://github.com/regmicmahesh-dotfiles/.tmux.git "/path/to/oh-my-tmux"
...
[my own Vim configuration]: https://github.com/regmicmahesh-dotfiles/.vim.git
